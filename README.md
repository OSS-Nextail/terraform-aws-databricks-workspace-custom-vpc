...
| <a name="input_workspaces"></a> [workspaces](#input\_workspaces) | Databricks workspaces name(s), to use with the deployment (optional) and workspace names. Will deploy as many workspaces as given names | `list(string)` | n/a | yes |
